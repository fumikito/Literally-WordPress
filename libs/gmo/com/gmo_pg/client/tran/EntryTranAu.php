 ...
 * @created 2012/02/15
 */
class EntryTranAu extends BaseTran {

	/**
	 * コンストラクタ
	 */
	function EntryTranAu() {
	    parent::__construct();
	}
	 ...
	 * 取引登録を実行する
	 *
	 * @param  EntryTranAuInput $input  入力パラメータ
	 * @return EntryTranAuOutput $output 出力パラメータ
	...
	function exec(&$input) {
        ...
        // EntryTranAuOutput作成し、戻す
	    return new EntryTranAuOutput($resultMap);
	}
}
?>