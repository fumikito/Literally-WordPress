 ...
 * @created 2012/06/14
 */
class EntryTranDocomo extends BaseTran {

	/**
	 * コンストラクタ
	 */
	function EntryTranDocomo() {
	    parent::__construct();
	}
	 ...
	 * 取引登録を実行する
	 *
	 * @param  EntryTranDocomoInput $input  入力パラメータ
	 * @return EntryTranDocomoOutput $output 出力パラメータ
	...
	function exec(&$input) {
        ...
        // EntryTranDocomoOutput作成し、戻す
	    return new EntryTranDocomoOutput($resultMap);
	}
}
?>
