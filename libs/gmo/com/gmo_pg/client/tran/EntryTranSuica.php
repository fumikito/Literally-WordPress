 ...
 */
class EntryTranSuica extends BaseTran {

	/**
	 * コンストラクタ
	 */
	function EntryTranSuica() {
	    parent::__construct();
	}
	 ...
	 * 取引登録を実行する
	 *
	 * @param  EntryTranSuicaInput $input  入力パラメータ
	 * @return EntryTranSuicaOutput $output 出力パラメータ
	...
	function exec(&$input) {
        ...
        // EntryTranSuicaOutput作成し、戻す
	    return new EntryTranSuicaOutput($resultMap);
	}
}
?>